...
<head>
	...
	<meta name="Description" content="AM Systems - Sistema de Gestão Odontológico">
	<meta name="Author" content="Abel Macedo">
	<meta name="Keywords" content="amsystesm odontologia, abel macedo,  sistema odontológico" />
							...
							<div class="main-card-signin d-md-flex">
								<div class="wd-100p">
									<div class="d-flex mb-4 justify-content-center"><a href="index.php">
											<img src="img/logo.jpg" class="sign-favicon" alt="logo" width="350px" style="border-radius: 10px"></a></div>
									<div class="">
										<div class="main-signup-header">
											...
											<div class="main-signin-footer text-center mt-3">
												...
												<p><a href="" class="mb-3" data-bs-toggle="modal" data-bs-target="#exampleModal" style="color: #3d8e8f;">Esqueceu sua
														Senha?</a></p>
											</div>
										</div>
									</div>
