...
<td class="esc">
	...
	<big><a href="#" class="btn btn-danger-light btn-sm" onclick="excluir('{$id}')" title="Excluir"><i class="fa fa-trash-can"></i></a></big>
		...
		<big><a class="btn btn-success btn-sm" href="#" onclick="relatorioMedico('{$id}', '{$cliente}', '{$nome_paciente}', '{$texto_relF}')" title="Relatório Dentista"><i class="fa fa-file-word-o"></i></a></big>
