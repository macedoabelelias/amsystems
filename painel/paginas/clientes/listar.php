...
if ($mostrar_registros == 'Não') {
	$query = $pdo->query("SELECT * from $tabela where usuario = '$id_usuario' order by nome asc");
} else {
...
<form   method="POST" action="rel/prontuario_class.php" target="_blank" style="display:inline-block">
					...
					<big><button class="btn btn-info-light btn-sm" title="Prontuário"><i class="fa fa-file-text "></i></button></big>
					</form>
